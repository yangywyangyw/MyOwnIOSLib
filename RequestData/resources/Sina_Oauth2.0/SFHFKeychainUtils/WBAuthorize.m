...
- (void)startAuthorize
{
    ...
    int height = hasStatusBar ? 460 : 480;
    height -= 44;
    
    WBAuthorizeWebView *webView = [[WBAuthorizeWebView alloc] initWithFrame:CGRectMake(0, 0, 320, height)];
    
    UIViewController *controller = [[UIViewController alloc] init];
    [controller setView:webView];
    
    UIBarButtonItem *leftBtn = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel 
                                                                             target:self 
    ...
    [controller.navigationItem setTitle:NSLocalizedString(@"登录", nil)];
